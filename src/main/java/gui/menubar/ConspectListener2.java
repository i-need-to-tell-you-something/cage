 ...
 *
 */
public class ConspectListener2 implements WindowListener {
	static String konspekt = "src/main.resources/ui/Notes.txt";

	@Override
	public void windowClosing(WindowEvent arg0) {
		// Konspekti akna sulgemisel võetakse tekst ja salvestatakse uuesti
		// konspekti faili
		String outtekst = ConspectListener1.getTekst().getText() + "      ";
		try {
