...
public class Kassiraam extends JFrame implements LocaleChangeListener {
	...
	public Kassiraam() {
		...
		kassiNupuRaam.setTitle(Locales.mainbundle.getString("title2"));
		...
		getFenoraam().setTitle(Locales.mainbundle.getString("title3"));
		...
		kassilist.setToolTipText(Locales.tipbundle.getString("tt1"));
