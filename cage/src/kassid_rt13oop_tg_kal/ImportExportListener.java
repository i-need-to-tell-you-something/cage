...
/** Managing exporting and importing cats with this program
 * @author K
 *
 */
public class ImportExportListener implements ActionListener, LocaleChangeListener {

	JFileChooser importer;
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getActionCommand().equals("Export")) {
			...
			importer = new JFileChooser("save/");
			importer.setFileFilter(new ImportExportListenerFilter());
			...
			importer.addActionListener(new FailiValijaKuular());
			
			//A dialog window to put the importer into
			JDialog impaken = new JDialog();
			
			//Setting the default button of the Dialog window
			JPanel nupukas = (JPanel) ( (JPanel)  (JPanel)importer.getComponent(3) ).getComponent(3);
			...
			System.out.println("This_shouldnt_happen_error: Not import nor Export");
		}
	}

	@Override
	public void onLocaleChange() {
		importer.setApproveButtonText(Main.mainbundle.getString("button10"));
		importer.setApproveButtonToolTipText(Main.tipbundle.getString("tt11"));
	}
}
